...
} from "./chunk-BFA5JADR.js";
import {
  ADMIN_PERMISSIONS_CE,
  HOOKS
} from "./chunk-CMMRF2M4.js";
import {
  require_pick
} from "./chunk-AFKAJ46W.js";
import {
  GuidedTourContext,
  useAIAvailability
...
import {
  useGetAIUsageQuery
} from "./chunk-3776H6DM.js";
import {
  useEnterprise
} from "./chunk-WJQZOPCB.js";
import {
  Login
} from "./chunk-QRZ35FG2.js";
import {
  Column,
  LayoutContent,
  Logo,
  UnauthenticatedLayout
} from "./chunk-5P5BZHVH.js";
import {
  ConfigurationProvider
} from "./chunk-M7HURBGD.js";
import {
  _setPrototypeOf
} from "./chunk-PC7SQHRX.js";
import {
  require_baseMerge,
...
import {
  HistoryProvider
} from "./chunk-2P55VKSC.js";
import {
  TrackingProvider,
  useTracking
} from "./chunk-272R6HMT.js";
import {
  getBasename
} from "./chunk-3F5SL26F.js";
import {
  useClipboard
} from "./chunk-XC5MMFTK.js";
import {
  createAbsoluteUrl,
  useInitQuery
} from "./chunk-FLV4SB6E.js";
import {
  ADMIN_PERMISSIONS_EE,
  AUDIT_LOGS_DEFAULT_PAGE_SIZE,
  getEERoutes
} from "./chunk-5AXJO3DH.js";
import {
  errorsTrads
} from "./chunk-XPL4GXGR.js";
import {
  ValidationError,
  create,
  create4 as create2,
...
} from "./chunk-HXLCSAO3.js";
import {
  Form
} from "./chunk-PD2YFYC6.js";
import {
  Layouts
} from "./chunk-UZS6V6BR.js";
import {
  getByteSize
} from "./chunk-JTTPC7SH.js";
import {
  RESPONSIVE_DEFAULT_SPACING
} from "./chunk-TDX3KHCB.js";
import {
  require_isEqual
} from "./chunk-72SGEO6W.js";
import {
  Page,
  l1,
  useAPIErrorHandler
...
import {
  ...
  require_isObject,
  require_root
} from "./chunk-BRFQF4O5.js";
import {
  L
} from "./chunk-FNI6BXPS.js";
import {
  provider_default,
  useIntl
...
import {
  _extends
} from "./chunk-TLJ72O6S.js";
import {
  require_react_dom
} from "./chunk-YQLJWIUJ.js";
import {
  require_react
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
    {
      path: "audit-logs",
      lazy: async () => {
        const { ProtectedListPage } = await import("./ListPage-M5OBTJJB.js");
        return {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
    {
      path: "single-sign-on",
      lazy: async () => {
        const { ProtectedSSO } = await import("./SingleSignOnPage-XRVNGQJV.js");
        return {
...
var AuthPage = () => {
  ...
  const { hasAdmin } = data ?? {};
  const Login$1 = useEnterprise(Login, async () => (await import("./Login-4JZZB6HO.js")).LoginEE);
  const forms = useEnterprise(FORMS, async () => (await import("./constants-Z2PJC7XT.js")).FORMS, {
...
var ROUTES_CE = [
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-5MXJO67T.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-XZYBPE2X.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-OAWH52VQ.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-LLM23KE4.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-64IU7AUN.js");
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-N2XN26NG.js");
      return {
        Component: ProtectedCreatePage
      };
    },
  ...
  {
    lazy: async () => {
      const editWebhook = await import("./EditPage-X5V6DIZH.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-6GWYGTLZ.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-JMYC3EAN.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-I74GFJAB.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditViewPage-DLRIUQWM.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-MX7TVFGM.js");
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-D7JEVISM.js");
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditView-UTL5QTRL.js");
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedInstalledPlugins } = await import("./InstalledPlugins-KZUU6GG2.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseAuditLogs } = await import("./PurchaseAuditLogs-CISGEBDN.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseSingleSignOn } = await import("./PurchaseSingleSignOn-M7O4G33L.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseContentHistory } = await import("./PurchaseContentHistory-OUXIQUC5.js");
      return {
...
var getImmutableRoutes = () => [
  {
    path: "usecase",
    lazy: async () => {
      const { PrivateUseCasePage } = await import("./UseCasePage-AR4PAP6E.js");
      return {
...
var getInitialRoutes = () => [
  {
    index: true,
    lazy: async () => {
      const { HomePage } = await import("./HomePage-6GAZI7XE.js");
      return {
        Component: HomePage
      };
    }
  },
  {
    path: "me",
    lazy: async () => {
      const { ProfilePage } = await import("./ProfilePage-76UAYTK2.js");
      return {
  ...
  },
  {
    path: "settings/*",
    lazy: async () => {
      const { Layout } = await import("./Layout-U35ALGIJ.js");
      return {
        Component: Layout
      };
    },
    children: [
      {
        ...
        lazy: async () => {
          const { ApplicationInfoPage } = await import("./ApplicationInfoPage-K4RDR7R5.js");
          return {
    ...
    const routes = [
      {
        ...
        children: [
          ...getImmutableRoutes(),
          {
            path: "/*",
            lazy: async () => {
              const { PrivateAdminLayout } = await import("./AuthenticatedLayout-A6VENJVV.js");
              return {
...
function __variableDynamicImportRuntime4__(path) {
  switch (path) {
    case "./translations/ar.json":
      return import("./ar.json-6RRHFSTH.js");
    case "./translations/ca.json":
      return import("./ca.json-NMVOL3OF.js");
    case "./translations/cs.json":
      return import("./cs.json-DL4B56AI.js");
    case "./translations/de.json":
      return import("./de.json-OLCHUFJW.js");
    case "./translations/dk.json":
      return import("./dk.json-TZQFVUZF.js");
    case "./translations/en.json":
      return import("./en.json-YBLIKEXU.js");
    case "./translations/es.json":
      return import("./es.json-CKU2XG44.js");
    case "./translations/eu.json":
      return import("./eu.json-7AGYMEKY.js");
    case "./translations/fr.json":
      return import("./fr.json-TQ2TG36Y.js");
    case "./translations/gu.json":
      return import("./gu.json-ZC2I6FEH.js");
    case "./translations/he.json":
      return import("./he.json-Z5UW6YOZ.js");
    case "./translations/hi.json":
      return import("./hi.json-IDZ6YMCM.js");
    case "./translations/hu.json":
      return import("./hu.json-7H2Q6KH4.js");
    case "./translations/id.json":
      return import("./id.json-EAYYAV54.js");
    case "./translations/it.json":
      return import("./it.json-SY5R2UNC.js");
    case "./translations/ja.json":
      return import("./ja.json-J77ABFTA.js");
    case "./translations/ko.json":
      return import("./ko.json-JUBWAWDA.js");
    case "./translations/ml.json":
      return import("./ml.json-ZEXU7ANZ.js");
    case "./translations/ms.json":
      return import("./ms.json-D6XJGDQO.js");
    case "./translations/nl.json":
      return import("./nl.json-ORZK2MCQ.js");
    case "./translations/no.json":
      return import("./no.json-L6TJ7P6I.js");
    case "./translations/pl.json":
      return import("./pl.json-Z6BJC5A4.js");
    case "./translations/pt-BR.json":
      return import("./pt-BR.json-Q3K23WBP.js");
    case "./translations/pt.json":
      return import("./pt.json-AZPHN7GI.js");
    case "./translations/ru.json":
      return import("./ru.json-4X6EKJX7.js");
    case "./translations/sa.json":
      return import("./sa.json-DDFYUFC5.js");
    case "./translations/sk.json":
      return import("./sk.json-ERYNUHVH.js");
    case "./translations/sv.json":
      return import("./sv.json-P4FHZH7I.js");
    case "./translations/th.json":
      return import("./th.json-AVUAISOM.js");
    case "./translations/tr.json":
      return import("./tr.json-DXFY722Y.js");
    case "./translations/uk.json":
      return import("./uk.json-RUJNYFDM.js");
    case "./translations/vi.json":
      return import("./vi.json-L3K6GT5H.js");
    case "./translations/zh-Hans.json":
      return import("./zh-Hans.json-MJZNYLP7.js");
    case "./translations/zh.json":
      return import("./zh.json-DFKJLT2Y.js");
    default:
      return new Promise(function(resolve, reject) {
...
function __variableDynamicImportRuntime3__(path) {
  switch (path) {
    case "./translations/en-GB.js":
      return import("./en-GB-6J3UV6SU.js");
    default:
      return new Promise(function(resolve, reject) {
        (typeof queueMicrotask === "function" ? queueMicrotask : setTimeout)(
          reject.bind(null, new Error("Unknown variable dynamic import: " + path))
    ...
    this.widgets.register([
      {
        ...
        component: async () => {
          const { ProfileWidget } = await import("./Widgets-XQ4TGSOU.js");
      ...
      },
      {
        ...
        component: async () => {
          const { KeyStatisticsWidget } = await import("./Widgets-XQ4TGSOU.js");
      ...
      this.widgets.register([
        {
          ...
          component: async () => {
            const { AuditLogsWidget } = await import("./Widgets-HZC4JWSG.js");
...
//# sourceMappingURL=chunk-NND6M2W6.js.map
